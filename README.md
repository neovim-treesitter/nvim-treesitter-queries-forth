# nvim-treesitter-queries-forth

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-forth/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-forth/actions/workflows/validate.yml)

Neovim tree-sitter queries for **forth**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-forth",
...
- [ ] Changes are scoped to `forth` — do not include files for other languages
